...
if __name__ == "__main__":
    ...
    cv_folds = os.listdir(path+"/results")
    ...
    for cv in cv_folds:
        ...
        #print("TESTING with "+cv)
        path_original = path+"/results/"+cv+"/benchmark_labels.tsv"
        path_annotated = path+"/results/"+cv+"/results_directory/p_values.tsv"
        path_deltas = path+"/results/"+cv+"/results_directory/deltas.tsv"
        ...
        os.system("Rscript --vanilla evaluate_for_inter.r "+path+" "+cv)
