...
new_score = c(MedF1_Big$score,mean(c(0.88,0.97,0.98,0.98,0.99,0.92,1.0,
                                     0.98,0.94,0.95,0.96,0.95,0.99,
                                     0.95,0.74,0.66,0.71,0.89,0.88,0.51,
                                     0.95,0.91,0.89,0.84,0.67,0.86,0.98,
                                     1.0,0.98,0.97,1.0,0.99,0.96,1.0,
                                     0.96,0.93,0.97,0.97,1.0,1.0,0.90,
                                     0.98,0.99,0.98,1.0,0.99,1.0,1.0)))
...
SCALT_results$Value <- c(0.88,0.97,0.98,0.98,0.99,0.92,1.0,
                         0.98,0.94,0.95,0.96,0.95,0.99,
                         0.95,0.74,0.66,0.71,0.89,0.88,0.51,
                         0.95,0.91,0.89,0.84,0.67,0.86,0.98,
                         1.0,0.98,0.97,1.0,0.99,0.96,1.0,
...
ggsave("inter_pbmc_Abdelaal_benchmark_with_multiassigned.pdf",plot =p2,dpi = 1000,width = 14, height = 6)
...
unlabScalt$Value <- c(0.55,0.55,0.71,0.91,0.93,0.93,0.59,
                      0.34,0.58,0.48,0.77,0.71,0.89,
                      0.63,0.98,0.93,0.99,0.99,0.99,0.59,
                      0.36,0.77,0.46,0.66,0.94,0.90,0.53,
                      0.57,0.75,0.64,0.66,0.89,0.96,0.95,
                      0.98,0.93,0.49,0.99,0.99,0.99,0.17,
                      0.46,0.71,0.53,0.70,0.81,0.86,0.91)
...
ggsave("inter_pbmc_unlabelledAbdelaal_benchmark_with_multiassigned.pdf",plot =p4,dpi = 1000,width = 14, height = 6)
...
ggsave("x_boxplots_with_multiassigned.pdf",plot =p,dpi = 1000,width = 13, height = 2.3)
...
p <- ggplot(MedF1_Big, aes(x = Classifier, y = Value)) + 
  ...
  coord_flip()
ggsave("y_boxplots.pdf_with_multiassigned.pdf",plot =p,dpi = 1000,width = 2, height = 6)
