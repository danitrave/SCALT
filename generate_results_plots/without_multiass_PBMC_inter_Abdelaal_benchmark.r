...
new_score = c(MedF1_Big$score,mean(c(0.82,0.85,0.79,0.80,0.49,0.73,0.77,0.89,0.87,0.81,0.83,0.82,0.89,0.80,0.09,0.13,0.0,0.0,0.6,0.52,
...
SCALT_results$Value <- c(0.82,0.85,0.79,0.80,0.49,0.73,0.77,0.89,0.87,0.81,0.83,0.82,0.89,0.80,0.09,0.13,0.0,0.0,0.6,0.52,
                         0.81,0.67,0.69,0.67,0.22,0.72,0.83,0.92,0.87,0.87,0.78,0.94,0.89,0.87,0.0,0.0,0.67,0.0,0.0,1.0,0.83,
                         0.93,0.97,0.90,0.84,0.85,0.68,0.92)
...
ggsave("inter_pbmc_Abdelaal_benchmark_without_multiassigned.pdf",plot =p2,dpi = 1000,width = 14, height = 6)
...
ggsave("inter_pbmc_unlabelledAbdelaal_benchmark_without_multiassigned.pdf",plot =p4,dpi = 1000,width = 14, height = 6)
...
ggsave("x_boxplots_without_multiassigned.pdf",plot =p,dpi = 1000,width = 13, height = 2.3)
...
p <- ggplot(MedF1_Big, aes(x = Classifier, y = Value)) + 
  ...
  coord_flip()
ggsave("y_boxplots.pdf_without_multiassigned.pdf",plot =p,dpi = 1000,width = 2, height = 6)
